...
<dt>
    <h4 class="name" id="type"><span class="type-signature"></span>type<span class="type-signature"> :string|<a href="Object.html">Object</a></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>Message field type. Type reference string if unresolved, protobuf type if resolved.</p>
    </div>
...
<dt>
        ...
        <h4 class="name" id="calculate"><span class="type-signature"></span>calculate<span class="signature">(value)</span><span class="type-signature"> &rarr; {number}</span></h4>
...
<dt>
        ...
        <h4 class="name" id="calculateValue"><span class="type-signature"></span>calculateValue<span class="signature">(value)</span><span class="type-signature"> &rarr; {number}</span></h4>
...
<dd>
    ...
    <div class="description">
        <p>Calculates the byte length of a value.</p>
    </div>
...
<dl class="details">
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="ProtoBuf.Reflect.Message.Field.html#calculateValue">ProtoBuf.Reflect.Message.Field#calculateValue</a>
    </li></dd>
...
<dt>
        ...
        <h4 class="name" id="encode"><span class="type-signature"></span>encode<span class="signature">(value, buffer)</span><span class="type-signature"> &rarr; {ByteBuffer}</span></h4>
...
<dt>
        ...
        <h4 class="name" id="encodeValue"><span class="type-signature"></span>encodeValue<span class="signature">(value, buffer)</span><span class="type-signature"> &rarr; {ByteBuffer}</span></h4>
...
<dd>
    ...
    <div class="description">
        <p>Encodes a value to the specified buffer. Does not encode the key.</p>
    </div>
...
<dl class="details">
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="ProtoBuf.Reflect.Message.Field.html#encodeValue">ProtoBuf.Reflect.Message.Field#encodeValue</a>
    </li></dd>
